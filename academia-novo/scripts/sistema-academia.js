        ...
        <div class="card">
            <div class="descricao-card">
                ...
                <p>Exercícios Adaptados: <b>${
                  aluno.exerciciosAdpatados ? "Sim" : "Não"
                }</b></p>
                <p>Professor Responsável: <b>${
                  aluno.professorResponsavel
                }</b></p>
                <p>Tem acesso: <span class="${
                  aluno.temAcesso ? "sim" : "nao"
                }" style="cursor:pointer" onclick="atualizaStatusAcesso(${
      aluno.id
    })"><b>${aluno.temAcesso ? "Sim" : "Não"}</b></span></p>
            ...
            <div class="acoes">
                ...
                <span class="material-icons acao" onclick="carregaDadosAluno(${
                  aluno.id
                })">
                      edit
                  </span>
...
const buscaPorProfessor = (nomeProfessor) => (aluno) =>
  aluno.professorResponsavel.toUpperCase().search(nomeProfessor.toUpperCase()) >
  -1;
